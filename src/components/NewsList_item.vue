		 		 ...
		 		 <mu-list-item >
		 			 <router-link :id="vlist.id" :vkey="vlist.vkey" :to="getPlayUrl(vlist.id,vlist.vkey)">
		 				 ...
		 				 <div class="video_desc">
		 					 <div class="desc_name" v-html="vlist.title"></div>
		 					 <div class="info_box">
		 						 <div class="desc_time"><img src="../assets/images/desc_vedio.png"/>{{vlist.date}}</div>
		 					 </div>
		 				 </div>
		 			 </router-link>
		 		 </mu-list-item>
...
export default {
	...
	methods: {
		...
		getArtList (clear) {
			...
			this.axios({
				method: 'GET',
				url: 'https://tv.gamefy.cn/api/get_art.php?page=' + data.current + '&k=' + data.searchfor
			})
